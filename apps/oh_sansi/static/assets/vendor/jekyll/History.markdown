...
### Minor Enhancements
  ...
  * Notify the self when auto-regeneration is disabled. (#2696)
...
### Minor Enhancements
  ...
  * In the generated site, remove files that will be replaced by a
    directory (#1118)
  * Fail loudly if a self-specified configuration file doesn't exist (#1098)
...
### Minor Enhancements
  ...
  * Tell the self if there is no subcommand specified (#1008)
...
### Major Enhancements
  ...
  * Maruku is now the only processor dependency installed by default.
      ...
      self to install them when necessary) (#57)
